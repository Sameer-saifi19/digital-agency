          ...
          <Link key={index} href={item.url} className="group">
            <div className="flex items-center border-b border-muted-foreground justify-between px-8 py-6 hover:bg-foreground text-background">
              <div className="flex gap-8 items-center">
                ...
                <h3 className="text-5xl lg:text-5xl font-bold transition-all duration-500 font-bricolage group-hover:text-background text-foreground">
                  {item.title}
                </h3>
              </div>
              <div className="flex items-center gap-8 max-w-md transition-all duration-500">
                <p className="text-base text-muted-foreground transition-all duration-500 group-hover:text-background">
                  {" "}
                  {item.description}
                </p>
                <ArrowUpRightIcon
